...
class PMMobile_SearchResults(runtests.SSTTestCase):
    ...
    def test_page_elements(self):
        ...
        fails(assert_element, css_class='class_that_doesnt_exist', name='whatever')
...
#you can write class-based tests when the file starts with test_* but you can't mix and match
def test():
    assert False
